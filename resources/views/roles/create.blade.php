                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('roles.store') }}" method="POST">
                        ...
                        <div>
                            ...
                            <div class="my-2">
                                <input value="{{ old('name') }}" placeholder="Enter Role Name" type="text" name="name" id="name" class="mt-1 block w-1/2 border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                @error('name')
